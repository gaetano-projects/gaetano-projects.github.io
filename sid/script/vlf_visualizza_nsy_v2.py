...
#  CARTELLA_XRAY        : cache locale per i dati X-ray GOES (creata automaticamente)
#  CARTELLA_FLARES      : cache locale per i flare NOAA (creata automaticamente)
...
CARTELLA_FLARES = r"C:\SID\dati\Storico\Flares"    # <-- modifica
